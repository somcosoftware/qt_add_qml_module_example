...
Item {
    ...
    Video {
        ...
        width: parent.width
        height: width * root.heightWidthRatio
                ...
                if (mouseX > root.width / 2) {
                    ...
                    root.toPosition(
                                (currentPosition + root.timingAdjustmentInterval
                                 < videoFile.duration) ? currentPosition + root.timingAdjustmentInterval : videoFile.duration)
                } else {
                    imgRewind.show()
                    root.toPosition(
                                currentPosition - root.timingAdjustmentInterval)
