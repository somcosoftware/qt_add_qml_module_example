...
Item {
    ...
    QtObject {
        ...
        function updateVolumeImage(value) {
            ...
            if (value > 0 && value < 50) {
                buttonVolume.source
                        = "qrc:/scythestudio.com/imports/Widgets/assets/icon-volume-down.svg"
            }
            if (value >= 50) {
                buttonVolume.source
                        = "qrc:/scythestudio.com/imports/Widgets/assets/icon-volume-up.svg"
            }
        }
    ...
    SSlider {
        ...
        onHoveredChanged: function () {
            root.toolBarHovered = sliderVideo.hovered
        }
    }
    ...
    SImageButton {
        ...
        anchors {
            ...
            topMargin: root.buttonTopMargin
            left: parent.left
            leftMargin: visible ? root.buttonSideMargin : 0
        }
        ...
        onHoveredChanged: function () {
            root.toolBarHovered = buttonPrevious.hovered
        }
    }
    ...
    SToggleButton {
        ...
        anchors {
            ...
            leftMargin: root.buttonSideMargin
        ...
        onHoveredChanged: function () {
            root.toolBarHovered = buttonPlay.hovered
        }
    }
    ...
    SImageButton {
        ...
        onHoveredChanged: function () {
            root.toolBarHovered = buttonNext.hovered
        }
    }
    ...
    SImageButton {
        ...
        onHoveredChanged: function () {
            root.toolBarHovered = buttonVolume.hovered
        }
    }
    ...
    SSlider {
        ...
        onHoveredChanged: function () {
            root.toolBarHovered = sliderVolume.hovered
        }
    }
    ...
    SToggleButton {
        ...
        anchors {
            ...
            topMargin: root.buttonTopMargin
            right: root.right
            rightMargin: root.buttonSideMargin
        }
        width: root.buttonSize
        height: root.buttonSize
        verticalPadding: SUtilities.dp(5)
        ...
        onHoveredChanged: function () {
            root.toolBarHovered = buttonFullScreen.hovered
        }
    }
